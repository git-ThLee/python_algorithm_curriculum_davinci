...
<img src = "../image/tree/binary search tree_find1.png" width="40%" height="40%"/>
<img src = "../image/tree/binary search tree_find2.png" width="40%" height="40%"/>
<img src = "../image/tree/binary search tree_find3.png" width="40%" height="40%"/>
...
<img src = "../image/tree/binary_search_tree_delete.png" width="40%" height="40%"/>

위 트리에서 6번노드를 삭제하려고 할 때는 자식노드를 위로 올려야 한다.

<img src = "../image/tree/binary_search_tree_delete2.png" width="40%" height="40%"/>
...
```python
    ...
    def delete(self, data):
        if data == self.root.data:
            ...
            if targetNode.leftNode == None and targetNode.rightNode == None:
                ...
                self.deleteNode(targetNode.leftNode, leftMax.data)
    ...
    def deleteNode(self, currentNode, data):
        ...
        if parent == False:
            return 'no data'
        elif parent == 'node is root':
            targetNode = currentNode
            if targetNode.leftNode == None and targetNode.rightNode == None:
                currentNode = None
            elif targetNode.leftNode == None:
                currentNode = targetNode.rightNode
            elif targetNode.rightNode == None:
                currentNode = targetNode.leftNode
            else:
                leftMax = self.MaxNode(targetNode.leftNode)
                self.deleteNode(targetNode.leftNode, leftMax.data)
                leftMax.leftNode = currentNode.leftNode
                leftMax.rightNode = currentNode.rightNode
                currentNode = leftMax
        elif parent[1] == 'right':
